...
import cn.annacode.org.common.tool.jieba.SegToken;
import cn.annacode.org.common.tool.jieba.WordDictionary;
...
public class PartOfSpeechTagging {
    ...
    private static  String DEFAULT_TAG_FILE = "/word/default_part_of_speech.txt";

    static {
        try {
            DEFAULT_TAG_FILE = Sys.GetPathParent()+Sys.jieba+"/word/default_part_of_speech.txt";
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
