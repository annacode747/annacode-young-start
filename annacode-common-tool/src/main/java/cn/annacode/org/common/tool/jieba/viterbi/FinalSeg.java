package cn.annacode.org.common.tool.jieba.viterbi;

import cn.annacode.org.common.tool.jieba.CharacterUtil;
import cn.annacode.org.common.tool.jieba.Node;
import cn.annacode.org.common.tool.jieba.Pair;
...
public class FinalSeg {
    ...
    private static String PROB_EMIT = "/prob_emit.txt";

    static {
        try {
            PROB_EMIT = Sys.GetPathParent()+Sys.jieba+"/prob_emit.txt";
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public synchronized static FinalSeg getInstance() throws FileNotFoundException {
    ...
    private void loadModel() throws FileNotFoundException {
        ...
        InputStream is = new FileInputStream(PROB_EMIT);
        try {
