...
public class ZipUtil {
    ...
    /**
     * @param pathsMap key fullPath 文件全路径 value visualPath 打压缩包 文件的路径
     * @param zos
     * @param dir
     * @throws IOException
     */
    ...
    /**
     * @param pathsMap     key fullPath 文件全路径 value visualPath 打压缩包 文件的路径 * @param
     *                     outPath 压缩文件路径
     * @param outName      压缩文件名
     * @param outExtension 压缩文件扩展名
     * @param charset      压缩编码
    ...
    /**
     * @param pathsMap key fullPath 文件全路径
